...
JELLYFISH_PROGRAMMER ?= avrispmkII

# Programmer Serial port (ex: usb, com5, ttyACM0)
JELLYFISH_PORT ?= usb
...
SRC = $(TARGET).c jellyfish-i2c.c utilities/usart.c utilities/delay.c i2cmaster/twimaster.c
...
#
AVRDUDE_PROGRAMMER = $(JELLYFISH_PROGRAMMER)

AVRDUDE_PORT = $(JELLYFISH_PORT)	   # programmer connected to serial device
